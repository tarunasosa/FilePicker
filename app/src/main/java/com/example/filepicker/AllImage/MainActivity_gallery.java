...
public class MainActivity_gallery extends AppCompatActivity implements itemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(ContextCompat.checkSelfPermission(MainActivity_gallery.this,
            ...
            ActivityCompat.requestPermissions(MainActivity_gallery.this,
        ...
        if(folds.isEmpty()){
            ...
            RecyclerView.Adapter folderAdapter = new pictureFolderAdapter(folds,MainActivity_gallery.this,this);
    ...
    public void onPicClicked(String pictureFolderPath, String folderName) {
        Intent move = new Intent(MainActivity_gallery.this,ImageDisplay.class);
